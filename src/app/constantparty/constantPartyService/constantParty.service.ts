...
export class ConstantPartyService {
  ...
  public getCpById(cpId: number, access_token: string, userId: number) {
    ...
    return this.http.get('http://83.212.113.1:8080/cp/' + cpId + "/" + userId, { headers: this.headers });
  }
  ...
  public getCpPhotos(cpId: number, access_token: string, userId: number): Observable<TodoItemNode> {
    ...
    return this.http.get<TodoItemNode>('http://83.212.113.1:8080/cp/' + cpId + '/' + userId + '/photos', { headers: headers });
  }
  ...
  public addNewFolder(cpId: number, access_token: string, folder: TodoItemNode) {
    ...
    return this.http.post('http://83.212.113.1:8080/cp/addFolder', JSON.stringify(folder),
      {
        headers: headers,
  ...
  public getUsersWithoutCp(access_token: string) {
    ...
    return this.http.get('http://83.212.113.1:8080/user/noCpPeople', { headers: this.headers });
  }
  ...
  public addUsersToCP(access_token: string, updateObject: UpdatableUser) {
    ...
    return this.http.put('http://83.212.113.1:8080/user/addPeopleToCp', updateObject, { headers: this.headers });
  }
  ...
  public deleteMember(access_token: string, characterId: number) {
    ...
    return this.http.delete('http://83.212.113.1:8080/cp/delete', {
  ...
  public getCPIdName(access_token: string): Observable<CP[]> {
    ...
    return this.http.get<CP[]>('http://83.212.113.1:8080/cp/getCPIdName', { headers: this.headers });
  }
  ...
  public addNewCP(access_token: string, cp: import("../add-new-constant-party/add-new-constant-party.component").CP) {
    ...
    return this.http.post('http://83.212.113.1:8080/cp/add', JSON.stringify(cp), { headers: this.headers });
  }
  ...
  public uploadImage(file: File, access_token: string, cpId: number, parentId: string): Observable<Boolean> {
    ...
    return this.http.post<Boolean>('http://83.212.113.1:8080/cp/upload', formData,
      {
        headers: this.headers,
        params: {
          'cpId': String(cpId),
  ...
  public removeFile(fileId: string, access_token: string) {
    ...
    return this.http.delete('http://83.212.113.1:8080/cp/file/delete',
      {
        headers: this.headers,
        params: {
          'fileId' : fileId
